...
export default function Topbar({
  ...
  // ==============================
  const PROFILE_API =
    'http://localhost/account-management-system/backend/api/users/profile.php';
  ...
  const getPageInfo = () => {
    switch (location.pathname) {
      ...
      case '/students':
        return {
          title: 'Students',
          subtitle: 'Manage student records and details'
        };

      case '/employees':
        return {
          title: 'Employee Management',
          subtitle: 'Manage employee records, roles, and salary details'
        };
      ...
      case '/calendar':
        return {
          ...
          subtitle: 'View upcoming holidays and events'
        };

      case '/payments':
        return {
          title: 'Payments',
          subtitle: 'Track and manage incoming payments'
        };

      case '/expenses':
        return {
          title: 'Expenses',
          subtitle: 'Monitor and record company expenses'
        };
      ...
      case '/create-invoice':
        return {
          ...
          subtitle: 'Generate and send a new invoice to a client'
        };

      case '/invoice-history':
        return {
          title: 'Invoice History',
          subtitle: 'View and manage previously generated invoices'
        };
      ...
      case '/hr/registration':
        return {
          ...
          subtitle: 'Register and onboard new employees'
        };
      ...
      case '/hr/documents':
        return {
          ...
          subtitle: 'Securely store and manage employee records'
        };
      ...
      case '/vendor-pos':
        return {
          title: 'Vendor POs',
          subtitle: 'Track and manage purchase orders issued to vendors'
        };
      ...
      default: {
        ...
        if (path) {
          ...
          return {
            ...
            subtitle: 'Overview of records and management'
          };
        }
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center pl-4 border-l border-slate-200 dark:border-dark-700">
            ...
            <div className="relative profile-dropdown-container flex items-center">
              ...
              {isProfileOpen && (
                <div className="absolute right-0 top-full mt-3 w-64 bg-white dark:bg-zinc-950 rounded-2xl shadow-xl border border-slate-100 dark:border-dark-700 overflow-hidden animate-fade-in z-50">
                  ...
                  <div className="group bg-slate-50 hover:bg-slate-100 dark:bg-zinc-900/50 dark:hover:bg-zinc-900 p-5 rounded-2xl border border-slate-100 dark:border-white/5 transition-colors">
                    ...
                    {isEditingProfile ? (
                      ...
                      <input
                        ...
                        className="w-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-2 text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-violet-500/50 transition-shadow"
                      />
